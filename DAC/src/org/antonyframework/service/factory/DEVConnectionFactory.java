 ...
 * 
 */
public class DEVConnectionFactory implements IConnectionFactory {

	private static final Log logger = LogFactory
			.getLog(DEVConnectionFactory.class);
	private static DEVConnectionFactory connectionFactory = new DEVConnectionFactory();
	...
	public static DEVConnectionFactory getInstance() {
