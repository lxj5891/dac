...
public class YMSMTP {
	...
	private static final Log LOG = LogFactory.getLog(YMSMTP.class);
	private static final String HOST = "smtp.ym.163.com";
	private static final String MAILER = "EPMSendMailer";
	private static final String ENCODING = "utf-8";
	private static final String USERNAME = "ycombo@ycombo.com";
	private static final String PASSWORD = "combo!@#$";

	public YMSMTP(String mailHost, String mailer, String encoding) {
	}
