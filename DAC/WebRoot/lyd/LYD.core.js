...
function ArrayList() {
    ...
    this.addElementAt = function (index, element) {
        ...
        if (index > elementCount || index < 0) {
            _trace("IndexOutOfBoundsException, Index: " + index + ", Size: " + elementCount);
            return;
    ...
    this.get = function (index) {
        ...
        if (index >= elementCount) {
            _trace("ArrayIndexOutOfBoundsException, " + index + " >= " + elementCount);
            return;
