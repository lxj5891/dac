$(document).ready(function () {
	...
	_date_button.mouseover(function () {
		$(this).css("cursor", "pointer");
	}).click(function () {
	...
	_info_button.mouseover(function () {
		$(this).css("cursor", "pointer");
	}).click(function () {
		_active_line.animate({
			"left" : "260"
	...
	_friends_button.mouseover(function () {
		$(this).css("cursor", "pointer");
	}).click(function () {
		_active_line.animate({
			"left" : "501"
	...
	var _days3_button = _days3_main.children(".days3").children("div");
	var _days7_main = $(".days7_main");
	var _days7_button = _days7_main.children(".days7").children("div");
	var _days15_main = $(".days15_main");
	var _days15_button = _days15_main.children(".days15").children("div");
	var _days30_main = $(".days30_main");
	var _days30_button = _days30_main.children(".days30").children("div");
